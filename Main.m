...
punto=input('Ingrese, 1 para Classification Discriminant, 2 para k vecinos Cercanos, 3 para Redes Neuronales ');
...
if punto==1
    ...
    for fold=1:Rept
        ...
        Xtest=normalizar(Xtest,mu,sigma);
         %%%  %%%
        Modelo = ClassificationDiscriminant.fit(Xtrain,Ytrain,'discrimType','linear');
